...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    excluded_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    minCartSubtotal: Schema.Attribute.Decimal;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    startsAt: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usageLimitPerAccount: Schema.Attribute.Integer;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coupon: Schema.Attribute.Relation<'manyToOne', 'api::coupon.coupon'>;
    coupon2: Schema.Attribute.Relation<'manyToOne', 'api::coupon.coupon'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    notesBase: Schema.Attribute.Relation<'oneToMany', 'api::note.note'>;
    notesHeart: Schema.Attribute.Relation<'oneToMany', 'api::note.note'>;
    notesTop: Schema.Attribute.Relation<'oneToMany', 'api::note.note'>;
    order_lines: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-line.order-line'
    >;
    promotion: Schema.Attribute.Relation<
      ...
      'api::promotion.promotion'
    >;
    promotion2: Schema.Attribute.Relation<
      'manyToOne',
      'api::promotion.promotion'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Component<'product.variant', true> &
      Schema.Attribute.Required;
  };
}
